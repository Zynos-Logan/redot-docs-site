...
Redot is [Free and open source Software ](https://en.wikipedia.org/wiki/Free_and_open_source_software)
...
For full details, look at the [COPYRIGHT.txt ](https://github.com/redot-engine/redot-engine/blob/master/COPYRIGHT.txt)
as well as the [LICENSE.txt ](https://github.com/redot-engine/redot-engine/blob/master/LICENSE.txt)
and [LOGO_LICENSE.txt ](https://github.com/redot-engine/redot-engine/blob/master/LOGO_LICENSE.txt) files
in the Redot repository.

Also, see [the license page on the Redot website ](https://redotengine.org/license).
...
[open issues ](https://github.com/redot-engine/redot-engine/issues?q=is%3Aopen+is%3Aissue+label%3Atopic%3Adotnet)_
...
like physics or navigation. All languages supported by Redot are fast enough for
...
means that C# can be faster in situations with few calls to Redot engine code.
However, C# can be slower than GDScript when making many Redot API calls, due
...
- Save [this .desktop file ](https://raw.githubusercontent.com/Redot-engine/Redot-engine/master/misc/dist/linux/org.godotengine.godot.desktop)_
...
[online documentation ](https://github.com/redot-engine/redot-engine-docs/issues).
...
[proposal issue ](https://github.com/redot-engine/redot-engine-proposals/issues).
...
[proposal discussion ](https://github.com/redot-engine/redot-engine-proposals/discussions).
...
Please, read the [readme ](https://github.com/redot-engine/redot-engine-proposals/blob/master/README.md)
