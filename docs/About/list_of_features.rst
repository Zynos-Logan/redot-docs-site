...
.. note::
    ...
    `3.x release series <https://docs.redotengine.org/en/3.6/about/list_of_features.html>`__.
...
- Linux (x86 and ARM, 64-bit and 32-bit).
   ...
   - Official binaries are compiled using the
     `Redot Engine buildroot <https://github.com/redot-engine/buildroot>`__,
...
- Official GDExtension bindings for `C <https://github.com/redot-engine/redot-headers>`__
  and `C++ <https://github.com/redot-engine/redot-cpp>`__.
...
- *3D scenes:* See :ref:`doc_importing_3d_scenes`.
   ...
   - FBX (by calling `FBX2glTF <https://github.com/redot-engine/FBX2glTF>`__ transparently).
   - Collada (.dae).
