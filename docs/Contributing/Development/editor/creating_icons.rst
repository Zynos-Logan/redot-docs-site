...
`set of predefined color mappings <https://github.com/redot-engine/redot-engine/blob/4.0.2-stable/editor/editor_themes.cpp#L60-L160>`__.
...
-  `editor/icons <https://github.com/redot-engine/redot-engine/tree/master/editor/icons>`__
