...
-  `servers/audio/audio_stream.h <https://github.com/redot-engine/redot-engine/blob/master/servers/audio/audio_stream.h>`__
-  `scene/audio/audio_stream_player.cpp <https://github.com/redot-engine/redot-engine/blob/master/scene/audio/audio_stream_player.cpp>`__
...
References:
~~~~~~~~~~~
-  `core/math/audio_frame.h <https://github.com/redot-engine/redot-engine/blob/master/core/math/audio_frame.h>`__
-  `servers/audio/audio_stream.h <https://github.com/redot-engine/redot-engine/blob/master/servers/audio/audio_stream.h>`__
-  `scene/audio/audio_stream_player.cpp <https://github.com/redot-engine/redot-engine/blob/master/scene/audio/audio_stream_player.cpp>`__
