...
.. seealso::
    ...
    `tests/test_macros.h <https://github.com/redot-engine/redot-engine/blob/master/tests/test_macros.h>`_
...
.. note::
    ...
    `issues related to GDScript at GitHub <https://github.com/redot-engine/redot-engine/issues?q=is%3Aissue+label%3Atopic%3Agdscript+is%3Aclosed>`_,
