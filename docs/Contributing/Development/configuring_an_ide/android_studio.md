...
- ``lib`` module:
   ...
   - The artifact generated by this module is made available for other Android modules / projects to use as a dependency, via [MavenCentral](https://repo1.maven.org/maven2/org/Redotengine/Redot/).
...
[Redot's Android dev channel](https://chat.redotengine.org/channel/android).