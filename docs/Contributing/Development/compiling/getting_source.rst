...
The source code is available on `GitHub <https://github.com/redot-engine/redot>`__
...
::
    ...
    git clone https://github.com/redot-engine/redot.git
...
`Redotengine/Redot-builds on GitHub <https://github.com/redot-engine/redot-builds/releases>`__.
