...
`Redot's source code <https://github.com/redot-engine/redot>`_, and send those
...
`good first issue <https://github.com/redot-engine/redot-engine/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22>`_
on GitHub.
...
Redot uses `GitHub's issue tracker <https://github.com/redot-engine/redot-engine/issues>`_
...
- **The tutorials and engine documentation and its translations.**
  ...
  `Redot-docs <https://github.com/redot-engine/redot-docs-site>`_ GitHub repository.
