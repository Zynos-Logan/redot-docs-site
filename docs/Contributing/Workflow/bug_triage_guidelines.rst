...
`GitHub repository <https://github.com/redot-engine/redot>`__.
...
The following `labels <https://github.com/redot-engine/redot-engine/labels>`__ are
...
-  *Documentation*: related to the documentation. PRs with this label improve the
   ...
   should be filed on the `Redot-docs <https://github.com/redot-engine/redot-docs-site>`_ repository.
...
-  *Feature proposal*: describes a wish for a new feature to be
   ...
   `Redot-proposals <https://github.com/redot-engine/redot-proposals>`__ instead.
...
In the `documentation repository <https://github.com/redot-engine/redot-docs-site>`__, we
use the following `labels <https://github.com/redot-engine/redot-docs-site/labels>`__:
...
`Milestones <https://github.com/redot-engine/redot-engine/milestones>`_ correspond to
