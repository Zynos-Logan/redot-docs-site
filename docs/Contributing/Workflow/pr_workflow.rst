...
The `repository on GitHub <https://github.com/redot-engine/redot>`_ is a
...
.. note:: If you are contributing to the documentation, its repository can
          be found `here <https://github.com/redot-engine/redot-docs-site>`_.
...
The first step is to *fork* the `Redotengine/Redot <https://github.com/redot-engine/redot>`_
