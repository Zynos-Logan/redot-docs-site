...
take care to keep things in sync. To achieve this the `main Redot repository <https://github.com/redot-engine/redot-engine/>`_
...
.. warning::
    ...
    `documentation repository <https://github.com/redot-engine/redot-docs-site/>`_.
...
the `Redot-docs repository <https://github.com/redot-engine/redot-docs-site/>`_
