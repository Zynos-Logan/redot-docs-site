...
editor, and it must inherit from [class_EditorPlugin](/docs/Classes/EditorPlugin).
...
[_enter_tree() ](/docs/Classes/Node_private_method__enter_tree) to initialize your plugin and
[_exit_tree() ](/docs/Classes/Node_private_method__exit_tree) to clean it up. Thankfully,
...
[add_custom_type() ](/docs/Classes/EditorPlugin_method_add_custom_type) from the
[class_EditorPlugin](/docs/Classes/EditorPlugin) class. This function can add new types to the editor
...
[class_Button](/docs/Classes/Button). It could also extend
[class_BaseButton](/docs/Classes/BaseButton) if you prefer:
...
**Project Settings**, so activate it as explained in [Checking the results](Checking the results).
...
For an editor dock, the root node **must** be a [Control ](/docs/Classes/Control)
...
[add_control_to_dock() ](/docs/Classes/EditorPlugin_method_add_control_to_dock) from the
[EditorPlugin ](/docs/Classes/EditorPlugin) class.
