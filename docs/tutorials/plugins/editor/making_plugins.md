...
editor, and it must inherit from [class_EditorPlugin](class_EditorPlugin).
...
[class_EditorPlugin](class_EditorPlugin) class. This function can add new types to the editor
...
[class_Button](class_Button). It could also extend
[class_BaseButton](class_BaseButton) if you prefer:
