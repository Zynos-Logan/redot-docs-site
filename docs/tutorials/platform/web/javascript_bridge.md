...
a Godot [JavaScriptObject ](class_JavaScriptObject) that tries to feel
...
Here is another example that asks the user for the [Notification permission ](https://developer.mozilla.org/en-US/docs/Web/API/Notifications_API)_
