...
Redot offers a first-party [`RedotGooglePlayBilling`` Android plugin compatible with Redot 4 which uses the `Google Play Billing library ](https://developer.android.com/google/play/billing).
