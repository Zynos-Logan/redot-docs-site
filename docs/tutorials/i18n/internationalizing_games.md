...
A good resource for multilingual fonts is [Noto Fonts ](https://www.google.com/get/noto/)_.
...
Translations can also be tested when [running Godot from the command line ](doc_command_line_tutorial).
