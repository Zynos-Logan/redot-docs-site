...
![Image](img/tls_certificates_project_setting.webp)
...
[PEM format ](https://en.wikipedia.org/wiki/Privacy-enhanced_Electronic_Mail)_.
...
(CA) such as [Let's Encrypt ](https://letsencrypt.org/)_. This is a more
...
and [certificates ](https://raw.githubusercontent.com/openssl/openssl/master/doc/HOWTO/certificates.txt)_.