...
[Open Sans ](https://fonts.google.com/specimen/Open+Sans)_ SemiBold
...
![Image](img/using_fonts_bitmap_font_from_image_import_options.webp)
...
[ASCII ](https://en.wikipedia.org/wiki/ASCII)_ characters and follows standard ASCII ordering:

![Image](img/using_fonts_monospace_bitmap_font_example.webp)

   Credit: [LibreQuake ](https://github.com/MissLav/LibreQuake/blob/master/lq1/gfx-wad/CONCHARS.png)_
   (scaled and cropped to exclude extended range)

The following import options can be used to import the above font image
successfully:

![Image](img/using_fonts_bitmap_font_from_image_example_configuration.webp)
...
![Image](img/using_fonts_load_font.webp)
...
![Image](img/using_fonts_outline_example.webp)
...
![Image](img/using_fonts_shadow.webp)

   Configuring font shadow in a Label node

The result should look like this:

![Image](img/using_fonts_shadow_example.webp)
...
![Image](img/using_fonts_antialiasing_comparison.webp)
...
![Image](img/using_fonts_hinting_comparison.webp)
...
Import dock. This will use [FreeType ](https://freetype.org/)_'s autohinter
...
Subpixel positioning can be adjusted. This is a [FreeType ](https://freetype.org/)_
...
- Fonts with self-intersecting outlines will not render correctly in MSDF mode.
  ...
  [Google Fonts ](https://fonts.google.com)_, try downloading the font from the
  font author's official website instead.

![Image](img/using_fonts_rasterized_vs_msdf_comparison.webp)
...
![Image](img/using_fonts_msdf_import_options.webp)
...
![Image](img/using_fonts_emoji_placeholder_characters.webp)

   Default appearance when trying to use emoji in a label

After adding a font to display emoji such as
[Noto Color Emoji ](https://fonts.google.com/noto/specimen/Noto+Color+Emoji)_,
you get the expected result:

![Image](img/using_fonts_emoji_correct_characters.webp)
...
Several modern icon fonts such as [Font Awesome 6 ](https://fontawesome.com/download)_
...
![Image](img/using_fonts_advanced_import_settings.webp)
...
![Image](img/using_fonts_font_fallbacks_add.webp)
...
![Image](img/using_fonts_font_fallbacks_load.webp)
...
![Image](img/using_fonts_font_variation_create.webp)

   Creating a FontVariation resource

![Image](img/using_fonts_font_variation_load.webp)
...
![Image](img/using_fonts_font_variation_variable_font.webp)
...
For example, here's the [Inter V ](https://rsms.me/inter/)_ font with a
*weight* of ``900`` and a *slant* of ``-10``:

![Image](img/using_fonts_font_variation_variable_font_example.webp)
...
![Image](img/using_fonts_font_variation_save_to_file.webp)
...
![Image](img/using_fonts_advanced_import_settings_opentype_features.webp)
...
![Image](img/using_fonts_font_variation_opentype_features.webp)

   Specifying OpenType features in a FontVariation resource

For example, here's the [Inter ](https://rsms.me/inter/)_ font without the
*Slashed Zero* feature (top), then with the *Slashed Zero* OpenType feature enabled
(bottom):

![Image](img/using_fonts_font_variation_slashed_zero.webp)
...
![Image](img/using_fonts_font_variation_disable_ligatures.webp)
...
![Image](img/using_fonts_system_font_specify.webp)
...
![Image](img/using_fonts_advanced_import_settings_prerender_new_configuration.webp)
...
![Image](img/using_fonts_advanced_import_settings_prerender_translation.webp)
...
![Image](img/using_fonts_advanced_import_settings_prerender_text.webp)
...
![Image](img/using_fonts_advanced_import_settings_prerender_character_map.webp)
