...
[Control.size ](/docs/Classes/Control_property_size)
...
[Control.focus_mode ](/docs/Classes/Control_property_focus_mode)
...
status, the [Control.has_focus() ](/docs/Classes/Control_method_has_focus) method
exists. Example
...
each other using a [VBoxContainer ](/docs/Classes/VBoxContainer),
...
[Control._get_minimum_size() ](/docs/Classes/Control_private_method__get_minimum_size),
for example:
...
This function is
[Control._gui_input() ](/docs/Classes/Control_private_method__gui_input).
