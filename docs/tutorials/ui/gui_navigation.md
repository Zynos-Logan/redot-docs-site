...
ready for [consoles ](../platform/consoles.md) (or just for people who prefer
...
Every [Control ](/docs/Classes/Control) node in Redot is capable of having focus.
...
example, [Label ](/docs/Classes/Label) nodes are set to "None" by default,
while [buttons ](/docs/Classes/Button) are set to "All".
