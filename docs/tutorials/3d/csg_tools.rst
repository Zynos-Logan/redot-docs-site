...
.. note:: The CSG nodes in Redot are mainly intended for prototyping. There is
          ...
          you may want to use `FuncRedot <https://github.com/func-godot/func_godot_plugin>`__
...
.. seealso::
    ...
    `Constructive Solid Geometry demo project <https://github.com/redot-engine/redot-demo-projects/tree/master/3d/csg>`__.
...
Redot uses the `manifold <https://github.com/elalish/manifold>`__ library to
...
Since Redot 4.4, you can convert a CSG node and its children to a :ref:`class_MeshInstance3D` node.
