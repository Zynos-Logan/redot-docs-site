...
![Image](img/particle_collision.webp)
...
![Image](img/particle_collision_common.webp)
...
![Image](img/particle_collision_box_entry.webp)
...
![Image](img/particle_collision_box.webp)

   Two particle systems collide with a box collision node

### Sphere collision

![Image](img/particle_collision_sphere_entry.webp)
...
![Image](img/particle_collision_sphere.webp)

   Two particle systems collide with a sphere collision node

### Height field collision

![Image](img/particle_collision_height.webp)
...
![Image](img/particle_heightfield_res.webp)
...
![Image](img/particle_collision_sdf_entry.webp)
...
![Image](img/particle_collision_sdf.webp)
...
![Image](img/particle_collision_sdf_res.webp)
