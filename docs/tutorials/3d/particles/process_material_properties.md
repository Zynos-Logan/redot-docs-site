...
![Image](img/particle_minmaxcurve.webp)
...
![Image](img/particle_direction.webp)
...
![Image](img/particle_spread.webp)
...
values for either of these properties [as described above ](#process-material-properties)_, the
...
![Image](img/particle_gravity.webp)
...
The [Damping ](#damping)_ property has no effect on the angular velocity.
...
change the speed of movement over a particle's lifetime [as described above ](#process-material-properties)_.
...
![Image](img/particle_accel_linear.webp)
...
![Image](img/particle_accel_radial.webp)

   Negative (left) and positive (right) radial acceleration

### Tangential acceleration

![Image](img/particle_tangent.webp)
...
![Image](img/particle_accel_tangent.webp)
...
property controls the range of available hues [as described above ](#process-material-properties)_.
...
![Image](img/particle_sprite.webp)
...
![Image](img/particle_animate.webp)
...
![Image](img/particle_animate_lifetime.webp)
...
is multiplied by the particle's [current scale ](#scale)_. You can use this to
...
![Image](img/particle_sub_mode.webp)
