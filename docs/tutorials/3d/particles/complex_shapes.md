...
![Image](img/particle_create_emission_points.webp)

   Create particle emission points...

![Image](img/particle_select_emission_mesh.webp)

   \...from a mesh instance as the source

![Image](img/particle_emission_density.webp)
...
![Image](img/particle_emission_textures.webp)
