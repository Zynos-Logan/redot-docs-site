...
- **Energy:** Energy multiplier. This is useful for saturating lights or working with [doc_high_dynamic_range](doc_high_dynamic_range).
- **Indirect Energy:** Secondary multiplier used with indirect light (light bounces). This works with [doc_using_lightmap_gi](doc_using_lightmap_gi), VoxelGI or SDFGI.
...
- **Bake Mode:** Sets the bake mode for the light. See [doc_using_lightmap_gi](doc_using_lightmap_gi).
