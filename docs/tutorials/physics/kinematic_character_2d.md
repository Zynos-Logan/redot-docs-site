...
[kinematic_character_2d_starter.zip ](https://github.com/redot-engine/redot-docs-site-project-starters/releases/download/latest-4.x/kinematic_character_2d_starter.zip).
