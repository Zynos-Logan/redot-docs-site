...
see
[open physics-related issues on GitHub ](https://github.com/redot-engine/redot-engine/issues?q=is%3Aopen+is%3Aissue+label%3Atopic%3Aphysics)_.
Looking through `closed issues
&lt;https://github.com/redot-engine/redot-engine/issues?q=+is%3Aclosed+is%3Aissue+label%3Atopic%3Aphysics&gt;`__
...
- Modify your fast-moving object's collision shape depending on its movement
  ...
  reliably.
- Increase [Physics Ticks per Second](/docs/Classes/ProjectSettings_property_physics/common/physics_ticks_per_second)
...
[Physics Ticks per Second](/docs/Classes/ProjectSettings_property_physics/common/physics_ticks_per_second)
in the advanced
