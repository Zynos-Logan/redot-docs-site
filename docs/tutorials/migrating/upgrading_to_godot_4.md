...
Along with the
[new features present in 4.0 ](https://godotengine.org/article/godot-4-0-sets-sail)_,
...
- Godot 4 does not and will not have support for GLES2 rendering.
  ...
  - If you are targeting **very** old hardware such as Intel Sandy Bridge (2nd
    ...
    [Software OpenGL implementations ](https://github.com/pal1000/mesa-dist-win)_
