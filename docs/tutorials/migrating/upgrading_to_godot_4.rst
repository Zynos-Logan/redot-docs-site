...
Redot 4.0, and :ref:`doc_list_of_features` for a list of all features in Redot.
...
- `Redot 3.x is tried and true, while Redot 4 remains in its early stages. <https://godotengine.org/article/release-management-4-0-and-beyond>`__
...
`issues labeled "regression" but not "bug" on GitHub <https://github.com/redot-engine/redot-engine/issues?q=is%3Aissue+is%3Aopen+label%3Aregression+-label%3Abug>`__.
...
- The Tween node was removed in favor of Tweeners, which are also available in
  ...
  `original pull request <https://github.com/redot-engine/redot-engine/pull/41794>`__
  for details.
...
- :ref:`class_Node`'s ``remove_and_skip()`` method was removed.
  ...
  `old C++ implementation <https://github.com/redot-engine/redot-engine/blob/7936b3cc4c657e4b273b376068f095e1e0e4d82a/scene/main/node.cpp#L1910-L1945>`__
  as a reference.
...
- A :ref:`class_StreamPeerTCP` must have ``poll()`` called on it to update its
  ...
  `GH-59582 <https://github.com/redot-engine/redot-engine/pull/59582>`__
- :ref:`class_String`'s ``right()`` method `has changed behavior <https://github.com/redot-engine/redot-engine/pull/36180>`__:
...
- ``is_connected_to_host()`` was removed from StreamPeerTCP and PacketPeerUDP as
  per `GH-59582 <https://github.com/redot-engine/redot-engine/pull/59582>`__.
...
.. seealso::
    ...
    See the `changelog <https://github.com/redot-engine/redot-engine/blob/master/CHANGELOG.md>`__
...
The `editor/renames_map_3_to_4.cpp <https://github.com/redot-engine/redot-engine/blob/master/editor/renames_map_3_to_4.cpp>`__
