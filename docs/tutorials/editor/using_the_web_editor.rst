...
There is a `Web editor <https://editor.redotengine.org/>`__ you can use to work
...
.. seealso::
    ...
    See the
    `list of open issues on GitHub related to the web editor <https://github.com/redot-engine/redot-engine/issues?q=is%3Aopen+is%3Aissue+label%3Aplatform%3Aweb+label%3Atopic%3Aeditor>`__
