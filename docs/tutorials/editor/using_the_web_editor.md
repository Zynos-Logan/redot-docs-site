...
[poor Firefox WebGL performance ](https://bugzilla.mozilla.org/show_bug.cgi?id=1010527)_,
...
[HTML5 FileSystem API ](https://developer.mozilla.org/en-US/docs/Web/API/FileSystem)_
