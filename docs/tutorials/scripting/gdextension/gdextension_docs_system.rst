...
`Redot-docs <https://github.com/redot-engine/redot-docs-site>`_ uses `Sphinx <https://www.sphinx-doc.org/en/master/>`_. You can use the repository as a basis to build your own documentation system. The following guide describes the basic steps, but they are not exhaustive: You will need a bit of personal insight to make it work.

1. Add `Redot-docs <https://github.com/redot-engine/redot-docs-site>`_ as a submodule to your ``docs/`` folder.
