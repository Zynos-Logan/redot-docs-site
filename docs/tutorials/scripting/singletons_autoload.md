...
[singleton_autoload_starter.zip ](https://github.com/redot-engine/redot-docs-site-project-starters/releases/download/latest-4.x/singleton_autoload_starter.zip)
