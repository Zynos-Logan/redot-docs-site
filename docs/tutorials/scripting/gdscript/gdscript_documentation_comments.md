...
break use ``[br]``. See also [BBCode and class reference](BBCode and class reference) below.
...
|  | ``[color]`` ``[/color]`` Color | ``[color=red]Error![/color]`` &lt;span style="color:red;"&gt;Error!&lt;/span&gt; | .. raw:: html |
|  | ``[font]`` ``[/font]`` Font | ``[font=res://mono.ttf]LICENSE[/font]`` &lt;span style="font-family:monospace;"&gt;LICENSE&lt;/span&gt; | .. raw:: html |
|  | ``[img]`` ``[/img]`` Image | ``[img width=32]res://icon.svg[/img]`` | .. image:: img/icon.svg :width: 32 px |
