...
Godot's internal classes have methods that register a class's data with a [ClassDB ](class_ClassDB). This database provides runtime access to class information. ``ClassDB`` contains
