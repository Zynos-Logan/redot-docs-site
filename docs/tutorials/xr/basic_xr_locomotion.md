...
For this we add a material to our PlaneMesh and set the albedo to a grid texture we've created with [Wahooneys excellent free texture generator ](https://wahooney.itch.io/texture-grid-generator). 
