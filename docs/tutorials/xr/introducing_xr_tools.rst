...
For this reason Redot has developed a toolkit called `Redot XR Tools <https://github.com/GodotVR/godot-xr-tools>`_
...
This can be downloaded from the `Redot XR Tools releases page <https://github.com/GodotVR/godot-xr-tools/releases>`_.
