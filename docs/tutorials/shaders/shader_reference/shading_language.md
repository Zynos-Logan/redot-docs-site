...
See [floating-point-gui.de ](https://floating-point-gui.de/)_ for more
information.
...
![Image](img/shading_language_adding_global_uniforms.webp)
...
![Image](img/shading_language_per_instance_uniforms_inspector.webp)
...
| --- | --- | --- |
| **bool** | **bool** |  |
| **bvec2** | **int** | Bitwise packed int where bit 0 (LSB) corresponds to x. For example, a bvec2 of (bx, by) could be created in the following way: .. code-block:: gdscript bvec2_input: int = (int(bx)) | (int(by) &lt;&lt; 1) |
