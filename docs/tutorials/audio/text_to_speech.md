...
- Non-English text works if the correct voices are installed and used. On Windows, you can consult the instructions in [this article](this article) to enable additional language voices on Windows.
