...
<TabItem value="node2d" label="Node2D">
...
<TabItem value="characterbody2d" label="CharacterBody2D">
...
<TabItem value="rigidbody2d" label="RigidBody2D">
...
<TabItem value="node3d" label="Node3D">
...
<TabItem value="characterbody3d" label="CharacterBody3D">
...
<TabItem value="rigidbody3d" label="RigidBody3D">
