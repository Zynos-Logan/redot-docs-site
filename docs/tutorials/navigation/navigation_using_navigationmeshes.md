...
![Image](img/nav_mesh_vs_physics.webp)
...
![Image](img/nav_mesh_baking_steps.gif)
...
<TabItem value="baking_with_a_navigationregion2d" label="Baking with a NavigationRegion2D">
...
<TabItem value="baking_with_a_navigationregion3d" label="Baking with a NavigationRegion3D">
...
![Image](img/navmesh_chunk_build.gif)
...
![Image](img/navmesh_bound_bordersize.webp)
...
![Image](img/navmesh_chunk_gaps.webp)
