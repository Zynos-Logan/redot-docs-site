...
A [MultiMesh](/docs/Classes/MultiMesh) is a single draw primitive that can draw up to millions
...
to the shader can be provided via textures (there are floating-point [Image](/docs/Classes/Image) formats
...
[RenderingServer.multimesh_set_buffer() ](/docs/Classes/RenderingServer_method_multimesh_set_buffer)
...
controlled with the [MultiMesh.visible_instance_count ](/docs/Classes/MultiMesh_property_visible_instance_count)
