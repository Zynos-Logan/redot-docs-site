...
![Image](img/using_tilesets_kenney_abstract_platformer_tile_sheet.webp)

   Tilesheet with 64×64 tiles. Credit: [Kenney ](https://kenney.nl/assets/abstract-platformer)_

Create a new **TileMapLayer** node, then select it and create a new TileSet resource in the inspector:

![Image](img/using_tilesets_create_new_tileset.webp)
...
![Image](img/using_tilesets_specify_size_then_edit.webp)
...
![Image](img/using_tilesets_create_tiles_automatically.webp)
...
![Image](img/using_tilesets_eraser_tool.webp)
...
![Image](img/using_tilesets_properties.webp)
...
![Image](img/using_tilesets_recreate_tiles_automatically.webp)
...
![Image](img/using_tilesets_creating_scene_collection.webp)
...
![Image](img/using_tilesets_scene_collection_create_scene_tile.webp)
...
![Image](img/using_tilesets_adding_scene_tile.webp)
...
![Image](img/using_tilesets_open_atlas_merging_tool.webp)
...
![Image](img/using_tilesets_create_physics_layer.webp)
...
![Image](img/using_tilesets_create_navigation_layer.webp)
...
![Image](img/using_tilesets_create_occlusion_layer.webp)
...
![Image](img/using_tilesets_selecting_collision_editor.webp)
...
![Image](img/using_tilesets_creating_triangle_collision.webp)
...
![Image](img/using_tilesets_drawing_custom_collision.webp)
...
![Image](img/using_tilesets_create_custom_data_layer.webp)

   Creating a custom data layer in the TileSet resource inspector (within the TileMapLayer node)

![Image](img/using_tilesets_custom_data_layers_example.webp)
...
![Image](img/using_tilesets_edit_custom_data.webp)
...
![Image](img/using_tilesets_paint_custom_data.webp)
...
![Image](img/using_tilesets_create_terrain_set.webp)
...
![Image](img/using_tilesets_create_terrain.webp)
...
![Image](img/using_tilesets_configure_terrain_on_tile.webp)
...
![Image](img/using_tilesets_configure_terrain_peering_bits.webp)
...
![Image](img/using_tilesets_terrain_example_tilesheet.webp)

   Example full tilesheet for a sidescrolling game

![Image](img/using_tilesets_terrain_example_tilesheet_configuration.webp)
...
![Image](img/using_tilesets_select_and_set_tile_properties.webp)
...
![Image](img/using_tilesets_paint_tile_properties.webp)
...
![Image](img/using_tilesets_paint_tile_properties_collision.webp)
...
![Image](img/using_tilesets_create_alternative_tile.webp)
...
![Image](img/using_tilesets_configure_alternative_tile.webp)
