...
![Image](img/2d_lights_and_shadows_disabled.webp)

   No 2D lights or shadows, scene is unshaded

![Image](img/2d_lights_and_shadows_enabled_no_shadows.webp)

   2D lights enabled (without shadows)

![Image](img/2d_lights_and_shadows_enabled.webp)
...
![Image](img/2d_lights_and_shadows_neutral_point_light.webp)
...
![Image](img/2d_lights_and_shadows_hard_shadow.webp)

   Hard shadows

![Image](img/2d_lights_and_shadows_soft_shadow.webp)

   Soft shadows (PCF13, Filter Smooth 1.5)

![Image](img/2d_lights_and_shadows_soft_shadow_streaks.webp)
...
them using the free and open source [Laigter ](https://azagaya.itch.io/laigter)_
tool.
...
![Image](img/2d_lights_and_shadows_create_canvastexture.webp)
