...
Redot provides two different nodes for 2D particles, [class_GPUParticles2D](/docs/Classes/GPUParticles2D)
and [class_CPUParticles2D](/docs/Classes/CPUParticles2D). GPUParticles2D is more advanced and uses the
...
While GPUParticles2D is configured via a [class_ParticleProcessMaterial](/docs/Classes/ParticleProcessMaterial)
...
![Image](img/particles_flipbook_result.webp)
...
![Image](img/particles_flipbook_example.webp)

   Credit: [JoesAlotofthings ](https://opengameart.org/content/alot-of-particles-indispersal-special-effect-alotofparticles30)_
   (CC BY 4.0)
...
![Image](img/particles_flipbook_create_canvasitemmaterial.webp)
...
![Image](img/particles_flipbook_configure_canvasitemmaterial.webp)
...
have a transparent background in an image editor. In [GIMP ](https://gimp.org)_,
...
![Image](img/particles_flipbook_configure_animation_speed.webp)
...
![Image](img/particles_flipbook_configure_animation_offset.webp)
