...
[SDL game controller database ](https://github.com/gabomdq/SDL_GameControllerDB)_.
...
&lt;https://github.com/redot-engine/redot-engine/blob/master/CONTRIBUTING.md#reporting-bugs&gt;`__.
...
[known issues with controller support ](https://github.com/redot-engine/redot-engine/issues?q=is%3Aopen+is%3Aissue+label%3Atopic%3Ainput+gamepad)_
on GitHub.
...
use the [Gamepad Tester ](https://gamepad-tester.com/)_ website to confirm that
...
the [SDL game controller database ](https://github.com/gabomdq/SDL_GameControllerDB)_.
