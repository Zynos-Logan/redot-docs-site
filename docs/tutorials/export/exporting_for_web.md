...
See [Can I use WebGL 2.0 ](https://caniuse.com/webgl2)_ for a list of browser
...
If you plan to use [VRAM compression ](doc_importing_images) make sure that
...
the default HTML page. See [doc_customizing_html5_shell](doc_customizing_html5_shell).
...
[make use of multithreading ](doc_using_multiple_threads) to improve
...
browser supporting the [Clipboard API ](https://developer.mozilla.org/en-US/docs/Web/API/Clipboard_API)_,
...
sadly the [Gamepad API ](https://developer.mozilla.org/en-US/docs/Web/API/Gamepad_API/Using_the_Gamepad_API)_
...
used, see [doc_customizing_html5_shell](doc_customizing_html5_shell).
...
([supports manual gzip precompression ](https://webd97.de/post/gitlab-pages-compression/)_)
