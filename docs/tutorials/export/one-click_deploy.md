...
- **iOS:**
   - Install Xcode, accept Xcode license and login with your Apple Developer
     account.
   - If you are using Xcode 14 or earlier, install [ios-deploy ](https://github.com/ios-control/ios-deploy)_
...
- Try [revoking the debugging authorization ](https://stackoverflow.com/questions/23081263/adb-android-device-unauthorized)_
...
- On Linux, you may be missing the required
  [udev rules ](https://github.com/M0Rf30/android-udev-rules)_
