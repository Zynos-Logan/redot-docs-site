...
See [doc_command_line_tutorial](doc_command_line_tutorial) for more information about using Godot
...
- Not readable and writable using tools normally present on the user's
  ...
  [third-party tools ](https://github.com/hhyyrylainen/GodotPckTool)_
...
Due to a [known bug ](https://github.com/godotengine/godot/pull/42123)_,
