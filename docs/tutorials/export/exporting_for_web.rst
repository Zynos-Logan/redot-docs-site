...
.. seealso::
    ...
    See the
    `list of open issues on GitHub related to the web export <https://github.com/redot-engine/redot-engine/issues?q=is%3Aopen+is%3Aissue+label%3Aplatform%3Aweb>`__
...
.. tip::
    ...
    `Python script to host a local web server <https://raw.githubusercontent.com/Redot-engine/Redot-engine/master/platform/web/serve.py>`__.
