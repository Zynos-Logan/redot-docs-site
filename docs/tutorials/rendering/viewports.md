...
If you need to render 3D shadows in the viewport, make sure to set the viewport's [positional_shadow_atlas_size](class_Viewport_property_positional_shadow_atlas_size) property to a value higher than ``0``.
