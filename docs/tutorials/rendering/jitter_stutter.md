...
[Feral GameMode ](https://github.com/FeralInteractive/gamemode)_ can be used
...
rate as per [this page ](https://blurbusters.com/howto-low-lag-vsync-on/)_.
...
[using the highest possible setting and reducing in-game sensitivity to reduce mouse latency ](https://www.youtube.com/watch?v=6AoRfv9W110)_.
