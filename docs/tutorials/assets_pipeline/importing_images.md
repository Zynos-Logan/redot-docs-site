...
- Khronos Texture (``.ktx``)
  - Decoding is done using [libktx ](https://github.com/KhronosGroup/KTX-Software)_.
...
- SVG (``.svg``)
  - SVGs are rasterized using [ThorVG ](https://www.thorvg.org/)_
  when importing them. [Support is limited ](https://www.thorvg.org/about#:~:text=among%20the%20svg%20tiny%20specs%2C%20yet%20unsupported%20features%20in%20the%20thorvg%20are%20the%20following)_;
  ...
  [web-based viewer ](https://www.thorvg.org/viewer)_.
  For complex vectors, rendering them to PNGs using [Inkscape ](https://inkscape.org/)_
  is often a better solution. This can be automated thanks to its
  [command-line interface ](https://wiki.inkscape.org/wiki/index.php/Using_the_Command_Line#Export_files)_.
- WebP (``.webp``)
...
![Image](img/importing_images_import_dock.webp)
...
![Image](img/importing_images_inspector_preview.webp)

   Previewing a texture in the Inspector. Credit: [Red Brick 03 - Poly Haven ](https://polyhaven.com/a/red_brick_03)_
...
![Image](img/importing_images_normal_map_rgtc.webp)
