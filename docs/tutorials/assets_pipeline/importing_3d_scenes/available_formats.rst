...
- FBX, supported via the `ufbx <https://github.com/ufbx/ufbx>`__ library. The
  previous import workflow used `FBX2glTF <https://github.com/redot-engine/FBX2glTF>`__
...
`Blender plugin <https://github.com/redot-engine/collada-exporter>`_
...
unless you have a specific reason to use it, you need to download the `FBX2glTF <https://github.com/redot-engine/FBX2glTF>`__
