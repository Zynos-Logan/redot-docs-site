...
[GDScript](../../tutorials/scripting/gdscript/gdscript_basics.md) is an
...
:::note
You must use the .NET edition of the Redot editor to script in C#. You
can download it on the Redot website's `download
&lt;https://redotengine.org/download/&gt;`_ page.

:::

Since Redot uses .NET 8, in theory, you can use any third-party .NET library or
...
.. attention::
    ...
    experimental and [some limitations apply](../../tutorials/scripting/c_sharp/index.md).
