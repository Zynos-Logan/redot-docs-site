...
The Project Manager is accessed by opening Godot, or if you already have Godot opened, click on *Project -&gt; Quit to Project List* (`Ctrl + Shift + Q`, `Ctrl + Option + Cmd + Q` on macOS)
