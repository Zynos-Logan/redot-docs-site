...
Download [dodge_the_creeps_2d_assets.zip](https://github.com/redot-engine/redot-docs-site-project-starters/releases/download/latest-4.x/dodge_the_creeps_2d_assets.zip).
