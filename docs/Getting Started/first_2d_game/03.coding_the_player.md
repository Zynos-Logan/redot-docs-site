...
[doc_scripting](../step_by_step/scripting_languages.md) before continuing.
...
see an explanation of vector usage in Redot at [doc_vector_math](../../tutorials/math/vector_math.md).
...
:::tip
The `delta[ parameter in the ]( parameter in the )process()` function refers to the *frame
