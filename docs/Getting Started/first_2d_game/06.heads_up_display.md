...
Create a new scene, click the "Other Node" button and add a [CanvasLayer](/docs/Classes/CanvasLayer) node named
``HUD``. "HUD" stands for "heads-up display", an informational display that
appears as an overlay on top of the game view.

The [CanvasLayer](/docs/Classes/CanvasLayer) node lets us draw our UI elements on
...
The basic node for UI elements is [Control](/docs/Classes/Control). To create our
UI, we'll use two types of [Control](/docs/Classes/Control) nodes: :ref:`Label
&lt;class_Label&gt;` and [Button](/docs/Classes/Button).

Create the following as children of the ``HUD`` node:

- [Label](/docs/Classes/Label) named ``ScoreLabel``.
- [Label](/docs/Classes/Label) named ``Message``.
- [Button](/docs/Classes/Button) named ``StartButton``.
- [Timer](/docs/Classes/Timer) named ``MessageTimer``.
