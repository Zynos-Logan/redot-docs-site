...
One way to do this is to use a [ColorRect](/docs/Classes/ColorRect) node. Make it
...
[TextureRect](/docs/Classes/TextureRect) node instead.
...
Add two [AudioStreamPlayer](/docs/Classes/AudioStreamPlayer) nodes as children of
...
property in the Inspector. Create a new [Shortcut](/docs/Classes/Shortcut) resource
...
Create a new [InputEventAction](/docs/Classes/InputEventAction) and name it ``start_game``.
...
And when you're ready, you can move on to [doc_your_first_3d_game](../first_3d_game/index.md) to learn
...
playable on. See [doc_exporting_projects](../../tutorials/export/exporting_projects.md) for instructions.
