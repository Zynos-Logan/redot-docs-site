...
And when you're ready, you can move on to [doc_your_first_3d_game](doc_your_first_3d_game) to learn
...
playable on. See [doc_exporting_projects](doc_exporting_projects) for instructions.
