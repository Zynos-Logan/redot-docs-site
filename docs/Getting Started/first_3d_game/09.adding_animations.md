...
Open the player scene, select the ``Player`` node, and add an [AnimationPlayer](/docs/Classes/AnimationPlayer) node.
...
Then open ``mob.tscn``, create an [AnimationPlayer](/docs/Classes/AnimationPlayer) child
