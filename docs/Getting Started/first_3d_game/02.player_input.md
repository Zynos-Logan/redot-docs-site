...
|image0|
 ...
 Create a [CharacterBody3D](/docs/Classes/CharacterBody3D) node as the root

![Image](img/02.player_input/add_character_body3D.webp)

Name the [CharacterBody3D](/docs/Classes/CharacterBody3D) to ``Player``.
...
[doc_physics_introduction](../../tutorials/physics/physics_introduction.md).
...
Add a [Node3D](/docs/Classes/Node3D) node as a child of ``Player`` and name it ``Pivot``
...
[CollisionShape3D](/docs/Classes/CollisionShape3D). In the *Inspector*, on the *Shape* property, add a new [SphereShape3D](/docs/Classes/SphereShape3D).
