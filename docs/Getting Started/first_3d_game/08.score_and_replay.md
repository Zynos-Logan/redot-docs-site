...
creating and editing themes, see [doc_gui_skinning](doc_gui_skinning).
...
You can learn more about string formatting here: [doc_gdscript_printf](doc_gdscript_printf).
...
another feature in Redot: [autoloads](doc_singletons_autoload).
